...
class CommonStyle extends Model
{
    ...
    public function style4()
    {
        ...
        $string = '';
        $width = 100 / count($this->data['pic_list']);
        foreach ($this->data['pic_list'] as $url) {
            ...
            <section style='text-align: center;margin-top: 10px;margin-bottom: 10px;width: 100%;box-sizing: border-box;'>
                    <section style='max-width: 100%;max-height:375px;vertical-align: middle;display: inline-block;line-height: 0;width: 100%;box-sizing: border-box;'>
                        <img data-ratio='0.625' src=".$url." data-type='jpeg' data-w='1000' style='vertical-align: middle;width: 100%;box-sizing: border-box;'>
                    </section>
                </section>
            </section>";
        }
            ...
            <section style='box-sizing: border-box;font-size: 16px;'>
                <section style='box-sizing: border-box;' powered-by='xiumi.us'>
                    <section style='display: inline-block;width: 100%;vertical-align: top;overflow-x: auto;box-sizing: border-box;'>
                        <section style='overflow: hidden;width: 400%;transform: rotate(0deg);-webkit-transform: rotate(0deg);-moz-transform: rotate(0deg);-o-transform: rotate(0deg);max-width: 400% !important;box-sizing: border-box;'>".$string."
                        </section>
                    </section>
                </section>
            </section>
