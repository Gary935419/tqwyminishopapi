    ...
    public function getMallSetting($columns = [])
    {
        if ($this->mallAllOptions) {
            ...
            foreach ($detail['option'] as $k => $item) {
                ...
                if (in_array($item['key'], ['good_negotiable', 'payment_type', 'send_type', 'business_time_type_week', 'business_time_type_day', 'quick_customize_new_params', 'send_type_desc', 'week_list', 'time_list', 'video_number_member_list', 'video_number_template_list'])) {
